...
print("\n1. 📥 CHARGEMENT DU FICHIER BINARISÉ...")
df = pd.read_csv("resources/Complementary_data/test_binarise_20_co.csv")
...
chemin_sauvegarde = "resources/Complementary_data/dataset_test20_schl_recategorise_test_co.csv"
